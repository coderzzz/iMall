...
//    _autotrophyImageView.image = [UIImage imageNamed:@"detail_title_ziying_tag"];
    ...
    _goodOldPriceLabel= [[UILabel alloc] init];
    _goodOldPriceLabel.font = PFR12Font;
    _goodOldPriceLabel.textColor = [UIColor lightGrayColor];
    [self addSubview:_goodOldPriceLabel];
    
    _goodCountLabel= [[UILabel alloc] init];
    _goodCountLabel.font = PFR12Font;
    ...
    _goodSubtitleLabel.textColor = [UIColor lightGrayColor];
...
//    }];
    ...
    [_goodOldPriceLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.mas_equalTo(self.goodPriceLabel.mas_right).offset(DCMargin);
        make.top.mas_equalTo(self.goodPriceLabel).offset(5);
        
    }];
    
    [_goodCountLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.right.mas_equalTo(self).offset(-DCMargin);
        make.top.mas_equalTo(self.goodPriceLabel).offset(10);
